...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'dropzone',
        defaults = {
            ...
            margin:                 5,                              //margin added if needed
            border:                 '4px dashed #ccc',              //border property
            background:             '',
            zIndex:                 100,                            //Z index of element
            textColor:              '#ccc',                         //text color
            textAlign:              'center',                       //css style for text-align
            text:                   'Click here / Drop files here to upload',    //text inside the div
            uploadMode:             'all',                       //upload all files at once or upload single files, options: all or single
            ...
            allowedFileTypes:       'pdf,csv,jpg,png',                            //allowed files to be uploaded seperated by ',' jpg,png,gif
